  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <a
          href="/modelo_inscricoes.xlsx"
          download="modelo_inscricoes.xlsx"
          className="text-sm text-blue-600 hover:text-blue-800 underline mt-3 inline-flex items-center gap-1"
        >
